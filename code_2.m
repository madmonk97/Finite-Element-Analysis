%Generate the connectivity matrix and global stiffness matrix for the elastic 
% deformation of a composite bar
function [conn, K] = code_2(element_lengths, element_areas) 
